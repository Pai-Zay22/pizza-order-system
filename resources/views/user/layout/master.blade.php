...
<body>
    ...
    <div class="container-fluid">
        ...
        <!-- Navbar Start -->
        <div class="container-fluid bg-dark mb-30 mt-3">
            <div class="row px-xl-5">
                <div class=" d-flex align-items-center">
                    <span class="h2 text-uppercase text-primary bg-dark px-2 mr-1">Pizza</span>
                    <span class="h2 text-uppercase text-dark bg-primary px-2 ml-n1">Myanmar</span>
                </div>
                <div class="col-lg-9">
